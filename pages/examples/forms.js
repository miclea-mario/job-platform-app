import { Button, DashboardLayout, Spinner } from '@components';
import {
  Checkbox,
  Combobox,
  DatePicker,
        ...
        <div className="mb-4 grid gap-4 md:grid-cols-3">
          <div>
            ...
            <Select placeholder="Where are you from?">
              ...
              <SelectItem value="2">Asia</SelectItem>
              <SelectItem value="3">Americas</SelectItem>
              <SelectItem value="4">Africa</SelectItem>
              <SelectItem value="5">Oceania</SelectItem>
              <SelectItem value="6">Antarctica (I'm a penguin)</SelectItem>
            </Select>
          </div>
          <div>
